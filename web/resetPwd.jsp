...
<input type="hidden" id="hasSidebar" value="1">	<div class="content user_modifyContent">
        <dl class="c_section">
            ...
            <dd>
                ...
                <%--由于表单的提交按钮无效，所以在表单下面使用了一个js提交到后台Controller--%>
            	<form id="updatePswForm" action="/comAccount/upload" method="post">
            		<table class="savePassword">
            			<tbody>
                            ...
                            <tr>
                                ...
                                <td><input type="password" maxlength="16" id="comfirmpassword" name="comfirmpassword"></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td><input type="submit" value="修改" onclick="check()"></td>
                            </tr>
            		    </tbody>
                    </table>
				</form>
        ...
        <script>
            function  check() {
                var result=window.confirm("您确认修改密码吗？");
                if(result){
                    window.location.href="/comAccount/upload/"+$('#oldpassword').val()+"/"+$('#newpassword').val();
                }
