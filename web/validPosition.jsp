...
<dl class="company_center_aside">
	...
	<dd>
		<a href="unvalidPositions.jsp">已下线职位</a>
	</dd>
	</dl>
            </div><!-- end .sidebar -->
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
			                	...
			                	<ul class="reset my_jobs">
				                			                            	<li data-id="149594">
		                                    <h3>
		                                        <a target="_blank" title="随便写">随便写</a>
		                                        <span>[上海]</span>
		                                        						                        		                                    </h3>
		                                    		                                  		<span class="receivedResumeNo"><a href="unHandleResumes.hjsp?positionId=149594">应聘简历（1）</a></span>
