...
<head>
    ...
    <script type="text/javascript" src="style/js/conv.js"></script></head>
<body>
<div id="body">

    <%@include file="top_toudi.jsp"%>

    <div id="container">
        <div class="sidebar">
            <a class="btn_create" href="create.jsp">发布新职位</a>
            <a class="btn_create" href="searchPublicedPosition.jsp">查看已发布职位</a>
            <dl class="company_center_aside">
                <dt>我收到的简历</dt>
                <dd class="current">
                    <a href="collected.jsp">已收藏的简历</a>
                </dd>
                <dd class="">
                        ...
                        <ul class="reset resumeLists">
                            ...
                            <li data-id="1686182" class="onlineResume">
                                    ...
                                    <div class="resumeIntro">
                                        ...
                                        <div >
                                            ...
                                            <table style="width: 500px;">
                                                <tr>
                                                    <td>姓名： ${jianliById.name} </td>
                                                    <td>年龄：${jianliById.age} 岁</td>
                                                </tr>
                                                <tr>
                                                    <td>地址：${jianliById.address}</td>
                                                    <td>状态：${jianliById.workstatus}</td>
                                                </tr>
                                                <tr>
                                                    <td>开始工作时间：${jianliById.startworktime}</td>
                                                    <td>行业：${jianliById.hopedhangye}</td>

                                                </tr>
                                                <tr>
                                                    <td>期望职位：${jianliById.hopedzhiwei}</td>
                                                    <td>工作类型：${jianliById.hopedworktype} </td>
                                                </tr>
                                                <tr>
                                                    <td>期望薪资：${jianliById.hopedsalary}</td>
                                                    <td>工作地址：${jianliById.hopedaddress}</td>
                                                </tr>
                                        ...
                                        <div class="jdpublisher">
				                                        <span>
				                                        	应聘职位：<a title="随便写" target="_blank" href="http://www.lagou.com/jobs/149594.html">${jianliById.hopedzhiwei}</a>
				                                       						                                        </span>
                                        </div>
                                    </div>
                                    <div class="links">
                                ...
                                <div class="contactInfo">
                                    <span class="c9">电话：</span>  ${jianliById.phone} &nbsp;&nbsp;&nbsp;
                                    <span class="c9">邮箱：</span><a href="mailto:888888888@qq.com">${jianliById.email}</a>
                                </div>
                            </li>
...
<script type="text/javascript">
    $(function(){
        var obj=document.getElementById("setSex");
        if(obj.val()==1){
            $(this).innerHtml="男";
