...
<div id="body">
 ...
 <div id="container">
     ...
     <div class="sidebar">
         ...
         <a class="btn_create" href="/ComPositionType/showAll" style="background-color: pink" >发布新职位</a>
         <a class="btn_create" href="/SelectAllPositions/${combasemsg.combasemsgid}" style="background-color: lightgreen">查看已发布职位</a>
       <dl class="company_center_aside">
        ...
        <dd>
            <a href="haveNoticedResumes.jsp">已通知面试简历</a>
        </dd>
        <dd>
    ...
    <dl class="company_center_aside">
        <dt>我发布的职位</dt>
        <dd>
            <a href="validPosition.jsp">有效职位</a>
        </dd>
        <dd>
            <a href="validPosition.jsp">已下线职位</a>
        </dd>
	</dl>
    <div class="subscribe_side mt20"></div>
    <div class="subscribe_side mt20">
       <div class="f14">加入互联网HR交流群</div>
       <div class="f18 mb10">跟同行聊聊</div>
       <div class="f24">110110110</div>
    </div>
</div><!-- end .sidebar -->
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	...
                    	<form action="/ComPosition/insertPosition" method="post" id="jobForm">
                            ...
                            <table class="btm">
                                        ...
                                        <div class="dn" id="box_job" style="display: none;">
                                            ...
                                            <dl>
                                                ...
                                                <dd>
                                                    <ul class="reset job_main">
                                                        <li>
                                                            <span>${maps['position0'][0].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position1']}">
                                                                     <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][1].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                <c:forEach var="p" items="${maps['position2']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][2].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                <c:forEach var="p" items="${maps['position3']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        ...
                                                        <li>
                                                            <span>${maps['position0'][3].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position4']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][4].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                <c:forEach var="p" items="${maps['position5']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][5].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                <c:forEach var="p" items="${maps['position6']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][6].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position7']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][7].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                <c:forEach var="p" items="${maps['position8']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                            ...
                                            <dl>
                                                ...
                                                <dd>
                                                    <ul class="reset job_main">
                                                        <li>
                                                            <span>${maps['position0'][8].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position9']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][9].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                <c:forEach var="p" items="${maps['position10']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][10].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                <c:forEach var="p" items="${maps['position11']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                            ...
                                            <dl>
                                                ...
                                                <dd>
                                                    <ul class="reset job_main">
                                                        <li>
                                                            <span>${maps['position0'][11].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position12']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][12].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                <c:forEach var="p" items="${maps['position13']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][13].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                <c:forEach var="p" items="${maps['position14']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][14].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position15']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                            ...
                                            <dl>
                                                ...
                                                <dd>
                                                    <ul class="reset job_main">
                                                        <li>
                                                            <span>${maps['position0'][15].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position16']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][16].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                <c:forEach var="p" items="${maps['position17']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][17].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                <c:forEach var="p" items="${maps['position18']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][18].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position19']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                            ...
                                            <dl>
                                                ...
                                                <dd>
                                                    <ul class="reset job_main">
                                                        <li>
                                                            <span>${maps['position0'][19].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position20']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][20].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                <c:forEach var="p" items="${maps['position21']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][21].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                <c:forEach var="p" items="${maps['position22']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][22].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position23']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                            ...
                                            <dl>
                                                ...
                                                <dd>
                                                    <ul class="reset job_main">
                                                        <li>
                                                            <span>${maps['position0'][23].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position24']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][24].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -160px;">
                                                                <c:forEach var="p" items="${maps['position25']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][25].typename}</span>
                                                            <ul class="reset job_sub dn" style="margin-left: -310px;">
                                                                <c:forEach var="p" items="${maps['position26']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                                        <li>
                                                            <span>${maps['position0'][26].typename}</span>
                                                            <ul class="reset job_sub dn">
                                                                <c:forEach var="p" items="${maps['position27']}">
                                                                    <li>${p.typename}</li>
                                                                </c:forEach>
                                                            </ul>
                                                        </li>
                                ...
                                <tr>
                                    ...
                                    <td>职位方向</td>
                                    <td>
                                        <input type="text" placeholder="请输入职位方向，如：JAVA" value="" name="positionDirection" id="positionName">
                                    </td>
                                </tr>
                                <tr>
                                    <td><span class="redstar">*</span></td>
                                    <td>职位名称</td>
                                    <td>
                                        <input type="text" placeholder="请输入职位方向，如：JAVA高级工程师" value="" name="positionname" id="position">
                                    </td>
                                </tr>
                                </tbody></table>
                            <table class="btm">
                                ...
                                <tr>
                                    ...
                                    <td width="85">学历要求</td>
                                    <td>
                                        <select  name="edu" id="edu" style="height: 45px ; width:356px;font: 18px/29px 微软雅黑,宋体,Arial;outline: none; cursor: pointer;color: #777;text-align:left;border: 2px solid #f1f1f1 !important;background: #fff url(img/select_r.png) right top no-repeat;padding: 6px 70px 6px 10px;">
                            	...
                            	<tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" width="500" placeholder="如：5.5-10k"  value="" id="salary" name="salary">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
                            ...
                            <table class="btm">
                                ...
                                <tr>
                                    ...
                                    <td width="85">所需人数</td>
                                    <td>
                                        <select  name="needed"  id="needed" style="width:356px;font: 18px/29px 微软雅黑,宋体,Arial;outline: none; cursor: pointer;color: #777;text-align:left; height: 45px;border: 2px solid #f1f1f1 !important;background: #fff url(img/select_r.png) right top no-repeat;padding: 6px 70px 6px 10px;">
                                        ...
                                        <span style="font: 18px/29px 微软雅黑,宋体,Arial;" >人</span>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="85">工作经验</td>
                                    <td>
                                        <select  name="experience" id="experience" style="width:356px;font: 18px/29px 微软雅黑,宋体,Arial;outline: none; cursor: pointer;color: #777;text-align:left; height: 45px;border: 2px solid #f1f1f1 !important;background: #fff url(img/select_r.png) right top no-repeat;padding: 6px 70px 6px 10px;">
                                            <option value="1">1</option>
                                            <option value="2">2</option>
                                            <option value="3">3</option>
                                            <option value="4">4</option>
                                        ...
                                        <span style="font: 18px/29px 微软雅黑,宋体,Arial;" >年</span>
                                    </td>
                                </tr>
                            </tbody></table>
                            ...
                            <table class="btm">
                                ...
                                <tr>
                                    ...
                                    <td width="85">职位信息</td>
                                    <td>
                                        <input type="text" placeholder="如：负责Java方向的开发" value="" id="positionmsg" name="positionmsg" class="input_520" id="positionmsg">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="85">发布时间</td>
                                    <td>
                                        <input type="text" placeholder="如：18年7月7日" value="" name="pubtime" id="pubtime" class="input_520" id="positionAdvantage">
                                    </td>
                                </tr>
                                <tr>
                                    <td><span class="redstar">*</span></td>
                                    <td>职位标签</td>
                                    <td>
                                        <input type="text" placeholder="如:需求分析..." value="" id="positionlable" name="positionlable" class="input_520" id="positionlable">
                                    </td>
                                </tr>
                                <tr>
                                    <td><span class="redstar">*</span></td>
                                    <td>工作地址</td>
                                    <td>
                                        <input type="text" placeholder="请输入详细的工作地址" value="" name="address" id="address" class="input_520" id="address">
                            ...
                            <table>
                            	<tbody><tr>
                                	<td width="25"><span class="redstar">*</span></td>
                                	<td colspan="2">
                                    	接收简历邮箱： <span id="receiveEmailVal">335456112@qq.com</span>
                                ...
                                <tr>
                                	...
                                	<td colspan="2">
                                    	...
                                    	<input type="submit" value="发布" id="formSubmit" class="btn_32" onclick="send()">
                                    </td>
                                </tr>
                         	</tbody></table>
                        </form>
        ...
        <script>
            function send(){
                $("#formSubmit").click(function(){
                    /*表单输入的数据*/
                        var recived_positionname=$("input[name='positionname']").val();
                        var recived_needed=$("#needed option:selected").text();
                        var recived_salary=$("#salary").val();
                        var recived_experience=$("#experience option:selected").text();
                        var reciver_edu=$("#edu option:selected").text();
                        var recived_address=$("#address").val();
                        var recived_pubtime=$("#pubtime").val();
                        var recived_positionlable=$("#positionlable").val();
                        var recived_positionmsg=$("#positionmsg").val();

                        /*通过ajax提交数据到后台controller*/
                        $.ajax({
                            type:"post",
                            url:"/ComPosition/insertPosition",
                            dataType:"json",
                            contentType: 'application/json;charset=UTF-8',
                            data:{

                                "positionname":recived_positionname,
                                "needed":recived_needed,
                                "salary":recived_salary,
                                "experience":recived_experience,
                                "edu":reciver_edu,
                                "pubtime":recived_pubtime,
                                "positionlable":recived_positionlable,
                                "positionmsg":recived_positionmsg,
                            },
